...
package it.trade.android.exampleapp.customtabs
    ...
    fun getPackageNameToUse(context: Context): String? {
        ...
        when {
            ...
            !TextUtils.isEmpty(defaultViewHandlerPackageName)
                    ...
                    && packagesSupportingCustomTabs.contains(defaultViewHandlerPackageName) -> sPackageNameToUse = defaultViewHandlerPackageName

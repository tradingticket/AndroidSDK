...
public class TradeItLinkedBrokerManager {
    ...
    public TradeItLinkedBrokerManager(
        TradeItApiClientParcelable apiClient,
        TradeItLinkedBrokerCache linkedBrokerCache,
        TradeItKeystoreService keystoreService,
        boolean prefetchBrokerList
    ) throws TradeItRetrieveLinkedLoginException {
    ...
    public synchronized void syncLocalLinkedBrokers(
        List<TradeItLinkedBrokerData> linkedBrokerDataList
    ) throws TradeItSaveLinkedLoginException, TradeItDeleteLinkedLoginException {
    ...
    private TradeItLinkedBrokerParcelable createNewLinkedBroker(TradeItLinkedBrokerData linkedBrokerData) {
        TradeItLinkedLoginParcelable linkedLoginParcelable = new TradeItLinkedLoginParcelable(
    ...
    public void authenticateAll(final TradeItCallbackWithSecurityQuestionAndCompletion callback) {
        ...
        Observable.fromIterable(this.getLinkedBrokers())
            ...
            .flatMapSingle(
                new Function<TradeItLinkedBrokerParcelable, Single<TradeItLinkedBrokerParcelable>>() {
                    @Override
                    public Single<TradeItLinkedBrokerParcelable> apply(@NonNull final TradeItLinkedBrokerParcelable linkedBrokerParcelable) throws Exception {
                        return Single.create(
                            new SingleOnSubscribe<TradeItLinkedBrokerParcelable>() {
                                @Override
    ...
    private synchronized SingleCache<List<Broker>> getAvailableBrokersSingleCache() {
        if (this.availableBrokersSingleCache != null) {
            ...
            Single single = Single.create(
                new SingleOnSubscribe<List<Broker>>() {
                    @Override
                    public void subscribe(@NonNull final SingleEmitter<List<Broker>> emitter) throws Exception {
                        ...
                        apiClient.getAvailableBrokers(
                            new TradeItCallback<List<Broker>>() {
                                @Override
    ...
    public void getFeaturedBrokersForInstrumentType(
        final Instrument instrumentType,
        final TradeItCallback<List<Broker>> callback
    ) {
    ...
    public void getNonFeaturedBrokersForInstrumentType(
        final Instrument instrumentType,
        final TradeItCallback<List<Broker>> callback
    ) {
    ...
    private List<Broker> getBrokerListForInstrumentType(
    ...
    public void getOAuthLoginPopupUrl(
        String broker,
    ...
    public void getOAuthLoginPopupForTokenUpdateUrl(
        TradeItLinkedBrokerParcelable linkedBroker,
        String deepLinkCallback,
        final TradeItCallback<String> callback
    ) {
        apiClient.getOAuthLoginPopupUrlForTokenUpdate(
            linkedBroker.getBrokerName(),
            linkedBroker.getLinkedLogin().userId,
            linkedBroker.getLinkedLogin().userToken,
            deepLinkCallback,
            new TradeItCallback<String>() {
                @Override
                public void onSuccess(String oAuthUrl) {
    ...
    public void getOAuthLoginPopupForTokenUpdateUrlByUserId(
        String userId,
        String deepLinkCallback,
        final TradeItCallback<String> callback
    ) {
        ...
        if (linkedBroker == null) {
            callback.onError(
                new TradeItErrorResultParcelable(
    ...
    public void linkBrokerWithOauthVerifier(final String accountLabel, String oAuthVerifier, final TradeItCallback<TradeItLinkedBrokerParcelable> callback) {
        apiClient.linkBrokerWithOauthVerifier(
            oAuthVerifier,
            new TradeItCallback<TradeItLinkedLogin>() {
                @Override
                public void onSuccess(TradeItLinkedLogin linkedLogin) {
                    try {
                        ...
                        TradeItApiClientParcelable
                            apiClientParcelable = new TradeItApiClientParcelable(
                            apiClient.getApiKey(),
                            apiClient.getEnvironment(),
                            apiClient.getRequestInterceptorParcelable()
                        );

                        TradeItLinkedBrokerParcelable linkedBroker = new TradeItLinkedBrokerParcelable(
                            apiClientParcelable,
    ...
    public void unlinkBroker(
        final TradeItLinkedBrokerParcelable linkedBroker,
        final TradeItCallback callback
    ) {
        try {
            keystoreService.deleteLinkedLogin(linkedBroker.getLinkedLogin());
            linkedBrokers.remove(linkedBroker);
     ...
     */
    @Deprecated
    public void linkBroker(
        final String accountLabel,
        String broker,
        String username,
        String password,
        final TradeItCallback<TradeItLinkedBrokerParcelable> callback
    ) {
        TradeItErrorResultParcelable errorResultParcelable = new TradeItErrorResultParcelable(

...
import trade.it.android.sdk.internal.TradeCallBackWithErrorHandling;
...
public class TradeItOrder {
    ...
    public void previewOrder(final TradeItCallback<TradeItPreviewStockOrEtfOrderResponse> callback) {
        ...
        this.linkedBrokerAccount.getTradeItApiClient().previewStockOrEtfOrder(previewRequest, new TradeCallBackWithErrorHandling<TradeItPreviewStockOrEtfOrderResponse, TradeItPreviewStockOrEtfOrderResponse>(callback) {
            @Override
